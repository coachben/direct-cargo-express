...
$destination_slug = 'ethiopia';
$destination_title = 'Freight services UK to Ethiopia';

// Intro Content
$destination_content = 'Shipping to Ethiopia has never been easier, we provide competitive rates for door to port and door to door cargo service to Addis Ababa. If you are international student, relocating to Ethiopia or do business in Ethiopia we are here to take care of all your export needs from UK to Ethiopia.';

// Bottom Description
$destination_description_bottom = 'Ethiopia, in the Horn of Africa, is a rugged, landlocked country split by the Great Rift Valley. With archaeological finds dating back more than 3 million years, it’s a place of ancient culture. The population of Ethiopia is 120.3 million and it\'s capital is Addis Ababa.';

// Images
$flag_image_path = 'Ethiopia FLAG.png';
$map_image_path = 'Ethiopia map.jpg';

// Pricing Table
// Data: Ethiopia, Addis Ababa, ADD.
// +100 kg: 4.50/kg (as seen). +500 kg: 4.25/kg (as seen). +1000 kg: £4/kg (as seen).
// Handling: £50 per shipment.
$pricing_table = array(
    'table_title' => 'AIRPORT TO AIRPORT',
    'table_description' => '
<ul class="list-none space-y-2">
    <li class="relative pl-5 before:content-[\'•\'] before:absolute before:left-0 before:text-orange before:font-bold">Up-to Bole Airport only</li>
    ...
    <li class="relative pl-5 before:content-[\'•\'] before:absolute before:left-0 before:text-orange before:font-bold">This is the quickest and cheapest way to ship to Ethiopia by air</li>
...
$container_load = array(
    'title' => 'Full container load to Modjo dry port or port of Djibouti, send us your requirements and we will revert with quote.',
    'description' => '',
    'image' => '',
...
if ($query->have_posts()) {
    $query->the_post();
    $post_id = get_the_ID();
    echo "Found Ethiopia Post ID: " . $post_id . "\n";
    ...
    echo "Created new Ethiopia Post ID: " . $post_id . "\n";
}
...
echo "Successfully updated ACF fields for Ethiopia.\n";
